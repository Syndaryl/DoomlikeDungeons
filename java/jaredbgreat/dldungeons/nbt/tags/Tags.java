...
public final class Tags {
	...
	public static ITag makeITag(Tokenizer tokens) {
		...
		case STRING:
			...
			break;
		case UUID:
			System.err.println("[DLDUNGEONS] WARNING! Trying to set UUID in NBT directly (not supported; ");
			System.err.println("[DLDUNGEONS] This tag will not be registered or used!");
			return null;
		case ENCH:
